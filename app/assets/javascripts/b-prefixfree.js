(function () {
    ...
    var e = window.StyleFix = {
        ...
        styleElement: function (t) {
            ...
            var n = t.disabled;
            t.textContent = e.fix(t.textContent, true, t);
            t.disabled = n
        },
...
(function (e) {
    ...
    var n = window.PrefixFree = {
        prefixCSS: function (e, r, i) {
            var s = n.prefix;
            if (n.functions.indexOf("linear-gradient") > -1) {
                e = e.replace(/(\s|:|,)(repeating-)?linear-gradient\(\s*(-?\d*\.?\d*)deg/ig, function (e, t, n, r) {
    ...
    (function () {
        ...
        if (n.Prefix == "Ms" && !("transform" in s) && !("MsTransform" in s) && "msTransform" in s) {
    ...
    (function () {
        ...
        for (var s in e) {
            var o = e[s],
                u = o.property,
                a = s + "(" + o.params + ")";
            if (!i(a, u) && i(n.prefix + a, u)) {
                n.functions.push(s)
            }
        }
        for (var f in t) {
            var u = t[f];
            if (!i(f, u) && i(n.prefix + f, u)) {
                n.keywords.push(f)
            }
        }
    })();
